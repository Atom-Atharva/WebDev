...
public:
    ...
    void setCoefficent(int degree, int coeff)
    {
        if (degree >= capacity)
        {
            int size = 2 * capacity;
    ...
    Polynomial operator+(Polynomial const &p)
    {
        ...
        while (i < this->capacity && j < p.capacity)
        {
            ...
            pNew.setCoefficent(deg, coeff);
            i++;
            j++;
        }
        while (i < capacity)
        {
            pNew.setCoefficent(i, degCoeff[i]);
            i++;
        }
        while (j < p.capacity)
        {
            pNew.setCoefficent(j, p.degCoeff[j]);
            j++;
        }
        return pNew;
    }
    ...
    Polynomial operator-(Polynomial p)
    {
        ...
        while (j < p.capacity)
        {
            pNew.setCoefficent(j, (-1 * p.degCoeff[j]));
            j++;
        }
        return pNew;
    }
